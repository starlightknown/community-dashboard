      ...
      <main className="flex-1 pb-16 relative">
        {!isConnected && (
          <div className="absolute inset-0 z-40 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
            <div className="max-w-md w-full bg-zinc-900 border border-zinc-800 rounded-3xl p-8 text-center shadow-2xl shadow-violet-500/10">
              ...
              <h2 className="text-2xl font-bold text-white mb-3 tracking-tight">Connect Discord</h2>
              <p className="text-zinc-400 mb-8 leading-relaxed">
                Unlock the leaderboard and start earning points by connecting your Discord account. Zencoder uses your Discord activity to track points and levels.
              </p>
              <button 
                onClick={() => setIsConnected(true)}
                className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white font-bold py-4 rounded-2xl transition-all shadow-lg shadow-[#5865F2]/20 active:scale-[0.98]"
              >
                Connect to Discord
              </button>
        ...
        <div className={!isConnected ? "opacity-20 blur-sm pointer-events-none transition-all duration-700" : "transition-all duration-700"}>
          <Hero />
