...
export default function DashboardPage() {
  ...
  const handleConnect = () => {
    setIsSyncing(true);
    // Simulate real Discord OAuth2 and data sync
    setTimeout(() => {
      setIsSyncing(false);
      setIsConnected(true);
    }, 2500);
              ...
              {isSyncing ? (
                <div className="py-8">
                  <div className="relative h-20 w-20 mx-auto mb-8">
                    ...
                    <div className="absolute inset-0 rounded-full border-4 border-t-[#5865F2] animate-spin" />
                  ...
                  <p className="text-sm text-zinc-500">Fetching messages, roles, and XP from Discord server.</p>
                </div>
              ) : (
                <>
